    ...
    useEffect(() => {
        ...
        const timer = () => {
            ...
            if (
                clapping &&
                playClap &&
                diff >= oneBeatInSeconds / 4 - offBeatClapDelay
            ) {
                clap();
            }
        };
                ...
                <Card.Body>
                    ...
                    >
                        <Switch
                            ...
                            aria-labelledby="{clapping}"
                        />
                        <h1>{clapping ? '👏' : '🔇'}</h1>
                        <ClapStyle
                            clapStyle={clapStyle}
                            onChange={(clapStyle: string) =>
                    ...
                    >
                        <TimeSignature
                            ...
                            onChange={(timeSig: number) =>
                                setTimeSigNum(timeSig)
                            }
                        />
                        <TimeSignature
                            timeSig={timeSigDen}
